...
![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/copy-api-gateway-endpoint.png)
...
![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/config-change.png)
...
![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/build-frontend.png)

After the build is complete, the **dist** folder will be created.

![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/mb-bucket.png)
...
![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/click-fe-bucket.png)
...
![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/copy-drag.png)

5. Click **Upload**, after upload success click **Close**

![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/click-upload.png)

6. Go to **Permissions** tab
7. Click **Edit** **Block public access (bucket settings)**

![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/click-edit-permisson.png)

8. Uncheck **Block public access**

![alt text](/workshop-fcj/images/5-Workshop/5.5-Policy/5.5.1-configure/unBLock-save.png)
